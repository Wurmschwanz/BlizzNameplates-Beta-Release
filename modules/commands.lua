...
SlashCmdList["BLIZZNAMEPLATESPLUS"] = function(msg)
  ...
  elseif msg == "debug" then
    ...
    BNP:Print("Commands: /bnp unknown, /bnp spellprobe, /bnp spelldb, /bnp guid, /bnp status, /bnp castbars on/off, /bnp scale <0.5-1.5>, /bnp scale reset, /bnp classcolors on/off, /bnp debug on, /bnp debug off")
  end
end
