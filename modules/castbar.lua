...
local function CreateCastbar(plate)
  ...
  bar:SetPoint("TOPLEFT", plate.healthbar, "BOTTOMLEFT", BAR_HEIGHT + 1, -BAR_GAP)
  bar:SetPoint("TOPRIGHT", plate.healthbar, "BOTTOMRIGHT", 14, -BAR_GAP)
  ...
  icon:SetWidth(14)
  icon:SetHeight(14)
  icon:SetPoint("TOPLEFT", plate.healthbar, "BOTTOMLEFT", 0, -BAR_GAP)
