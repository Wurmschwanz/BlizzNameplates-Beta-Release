...
function BNP:CreateOptions()
  ...
  local targetOnTop = CreateCheck(frame, "Target Plate on Top", -422, function()
  ...
  -- AURAS ------------------------------------------------------------------
  CreateSection("Auras", -462)

  local icon = CreateSlider(frame, "Aura Icon Size", 12, 32, 1, -492)
  ...
  local debuffs = CreateCheck(frame, "Debuffs", -530, function()
  ...
  local crowdControl = CreateCheck(frame, "Crowd Control", -556, function()
  ...
  local separateCCRow = CreateCheck(frame, "Display CCs in Separate Row", -582, function()
  ...
  local showOtherCCs = CreateCheck(frame, "Show CCs from Other Players", -608, function()
  ...
  -- CASTBAR ----------------------------------------------------------------
  CreateSection("Castbar", -648)

  local castbars = CreateCheck(frame, "Castbars", -674, function()
  ...
  local castbarHeight = CreateSlider(frame, "Castbar Height", 4, 14, 1, -710)
  ...
  if comboOptionsClass then
    local classSection = CreateSection("Class Features", -750)
    frame.classSection = classSection

    local comboPoints = CreateCheck(frame, "Combo Points", -776, function()
