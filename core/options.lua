...
function BNP:CreateOptions()
  ...
  frame:SetWidth(310)
  frame:SetHeight(comboOptionsClass and 770 or 710)
  ...
  local classColors = CreateCheck(frame, "Class Colors", -136, function()
  ...
  local tank = CreateCheck(frame, "Tank Mode", -162, function()
  ...
  healthTextLabel:SetPoint("TOPLEFT", frame, "TOPLEFT", 28, -196)
  ...
  healthTextDropdown:SetPoint("TOPLEFT", frame, "TOPLEFT", 10, -208)
  ...
  local targetFocus = CreateCheck(frame, "Target Glow", -252, function()
  ...
  glowColorLabel:SetPoint("TOPLEFT", frame, "TOPLEFT", 42, -282)
  ...
  glowColorDropdown:SetPoint("TOPLEFT", frame, "TOPLEFT", 24, -294)
  ...
  local targetOnTop = CreateCheck(frame, "Target Plate on Top", -338, function()
  ...
  -- AURAS ------------------------------------------------------------------
  CreateSection("Auras", -378)

  local icon = CreateSlider(frame, "Aura Icon Size", 12, 32, 1, -408)
  ...
  local debuffs = CreateCheck(frame, "Debuffs", -446, function()
  ...
  local crowdControl = CreateCheck(frame, "Crowd Control", -472, function()
  ...
  local separateCCRow = CreateCheck(frame, "Display CCs in Separate Row", -498, function()
  ...
  local showOtherCCs = CreateCheck(frame, "Show CCs from Other Players", -524, function()
  ...
  -- CASTBAR ----------------------------------------------------------------
  CreateSection("Castbar", -564)

  local castbars = CreateCheck(frame, "Castbars", -590, function()
  ...
  local castbarHeight = CreateSlider(frame, "Castbar Height", 4, 14, 1, -626)
  ...
  if comboOptionsClass then
    local classSection = CreateSection("Class Features", -666)
    frame.classSection = classSection

    local comboPoints = CreateCheck(frame, "Combo Points", -692, function()
  ...
  note:SetPoint("TOPLEFT", frame, "TOPLEFT", 28, noteY)
  note:SetWidth(250)
